...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form style="background: rgb(245,245,245); width: 700px; left: 35%" onsubmit="preventDefault()" class="box" action="download" method="post">
...
<%--    <input type="text" name="email" placeholder="Email" value="${user.email}" style="margin-bottom: 20px" >--%>
